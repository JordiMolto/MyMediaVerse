...
async function handleEnrichWithTMDB() {
  console.log('handleEnrichWithTMDB called in CompletedView')
  const items = getSelectedItems(filteredItems.value)
...
<template>
  <div class="collection-view">
    ...
    <!-- Global App FAB -->
    <AppFab @click="uiStore.toggleQuickAdd(true, { type: selectedType || undefined, status: ItemStatus.COMPLETED })" />
